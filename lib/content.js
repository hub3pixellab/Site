...
export const team = [
  {
    ...
    quote: {
      pt: 'Pioneiro tech, artista multimídia e o cara que escreveu o manual da liderança do amanhã.',
      en: 'Tech pioneer, multimedia artist and the guy who wrote the playbook for tomorrow’s leadership.',
    },
    bio: {
      pt: [
    ...
    tags: [
      { icon: 'briefcase', label: { pt: 'Gestão Pública', en: 'Public Mgmt' } },
  ...
  },
  {
    ...
    tags: [
      ...
      { icon: 'calculator', label: { pt: 'Auditoria Financeira', en: 'Financial Auditing' } },
      { icon: 'target', label: { pt: 'Smart Contracts', en: 'Smart Contracts' } },
      { icon: 'sparkles', label: { pt: 'Tokenomics', en: 'Tokenomics' } },
      { icon: 'briefcase', label: { pt: 'B2B SaaS', en: 'B2B SaaS' } },
    ],
  },
];
